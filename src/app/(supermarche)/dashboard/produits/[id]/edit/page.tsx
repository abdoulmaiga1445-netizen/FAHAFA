  ...
  const fetchProduct = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        setPrix(product.price.toString());
        setPrixPromo(product.comparePrice?.toString() || '');
        setStock(product.stock.toString());
        setUnite(product.unit);
        setCategorieId(product.category.id);
        setCodeBarres(product.codeBarres || '');
      ...
      <main className="flex-1">
        <div className="max-w-2xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-muted-foreground">/</span>
            <span className="text-sm font-medium text-[#1B4332]">Modifier</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#1B4332]">Modifier le produit</h1>
